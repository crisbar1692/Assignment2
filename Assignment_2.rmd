...
plot(model_alkanes,ncomp=3,xlab="Measured boiling points",ylab="Predicted boiling boints", main="Prediction vs Plot Trainnig set and 3 components",line=TRUE,asp=1)
```
...
plot(predicted_values,measured_values,xlab="measured Boiled Points",ylab="Predicted Boiled Points", main="Prediction vs Plot Test set 3 components",lwd=1,asp=1,pch=16,col="blue", cex=1.5,cex.main=1.2,col.main="red")
