...
#Making a random selection of descriptor to find the best prediction
...
plot(model_alkanes,ncomp=3,xlab="measured Boiled Points",ylab="Predicted Boiled Points", main="Prediction vs Plot Train set 3 components",line=TRUE,asp=1)
```
...
print(RMSEP_3comp)
predplot(model_alkanes,ncomp=3,which = "test",newdata=test_set,xlab="measured Boiled Points",ylab="Predicted Boiled Points", main="Prediction vs Plot Test set 3 components",line=TRUE,asp=1)
